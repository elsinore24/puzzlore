...
/// A puzzle view without its own background - designed to overlay on the constellation background
/// Used for the fade transition from constellation map to puzzle
struct PuzzleOverlayView: View {
    ...
    @State private var boostRevealedIndex: Int? = nil
    ...
    var body: some View {
        GeometryReader { geo in
            ...
            ZStack {
                // No background - transparent to show constellation behind
...
// MARK: - Top Bar
private extension PuzzleOverlayView {
